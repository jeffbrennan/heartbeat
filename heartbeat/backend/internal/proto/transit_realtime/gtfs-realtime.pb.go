...
// Deprecated: Do not use.
func (x *TripUpdate_StopTimeUpdate_ScheduleRelationship) UnmarshalJSON(
	b []byte,
) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
...
const (
	Default_TripModifications_Modification_PropagatedModificationDelay = int32(
		0,
	)
)
...
const file_gtfs_realtime_proto_rawDesc = "" +
	...
	"\astop_id\x18\x02 \x01(\tR\x06stopId*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90NBW\n" +
...
func file_gtfs_realtime_proto_rawDescGZIP() []byte {
	file_gtfs_realtime_proto_rawDescOnce.Do(func() {
		file_gtfs_realtime_proto_rawDescData = protoimpl.X.CompressGZIP(
			unsafe.Slice(
				unsafe.StringData(file_gtfs_realtime_proto_rawDesc),
				len(file_gtfs_realtime_proto_rawDesc),
			),
		)
	})
...
var file_gtfs_realtime_proto_goTypes = []any{
	(FeedHeader_Incrementality)(
		0,
	), // 0: transit_realtime.FeedHeader.Incrementality
	(TripUpdate_StopTimeUpdate_ScheduleRelationship)(
		0,
	), // 1: transit_realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship
	(VehiclePosition_VehicleStopStatus)(
		0,
	), // 2: transit_realtime.VehiclePosition.VehicleStopStatus
	(VehiclePosition_CongestionLevel)(
		0,
	), // 3: transit_realtime.VehiclePosition.CongestionLevel
	(VehiclePosition_OccupancyStatus)(
		0,
	), // 4: transit_realtime.VehiclePosition.OccupancyStatus
	(Alert_Cause)(
		0,
	), // 5: transit_realtime.Alert.Cause
	(Alert_Effect)(
		0,
	), // 6: transit_realtime.Alert.Effect
	(Alert_SeverityLevel)(
		0,
	), // 7: transit_realtime.Alert.SeverityLevel
	(TripDescriptor_ScheduleRelationship)(
		0,
	), // 8: transit_realtime.TripDescriptor.ScheduleRelationship
	(VehicleDescriptor_WheelchairAccessible)(
		0,
	), // 9: transit_realtime.VehicleDescriptor.WheelchairAccessible
	(Stop_WheelchairBoarding)(
		0,
	), // 10: transit_realtime.Stop.WheelchairBoarding
	(*FeedMessage)(
		nil,
	), // 11: transit_realtime.FeedMessage
	(*FeedHeader)(
		nil,
	), // 12: transit_realtime.FeedHeader
	(*FeedEntity)(
		nil,
	), // 13: transit_realtime.FeedEntity
	(*TripUpdate)(
		nil,
	), // 14: transit_realtime.TripUpdate
	(*VehiclePosition)(
		nil,
	), // 15: transit_realtime.VehiclePosition
	(*Alert)(
		nil,
	), // 16: transit_realtime.Alert
	(*TimeRange)(
		nil,
	), // 17: transit_realtime.TimeRange
	(*Position)(
		nil,
	), // 18: transit_realtime.Position
	(*TripDescriptor)(
		nil,
	), // 19: transit_realtime.TripDescriptor
	(*VehicleDescriptor)(
		nil,
	), // 20: transit_realtime.VehicleDescriptor
	(*EntitySelector)(
		nil,
	), // 21: transit_realtime.EntitySelector
	(*TranslatedString)(
		nil,
	), // 22: transit_realtime.TranslatedString
	(*TranslatedImage)(
		nil,
	), // 23: transit_realtime.TranslatedImage
	(*Shape)(
		nil,
	), // 24: transit_realtime.Shape
	(*Stop)(
		nil,
	), // 25: transit_realtime.Stop
	(*TripModifications)(
		nil,
	), // 26: transit_realtime.TripModifications
	(*StopSelector)(
		nil,
	), // 27: transit_realtime.StopSelector
	(*ReplacementStop)(
		nil,
	), // 28: transit_realtime.ReplacementStop
	(*TripUpdate_StopTimeEvent)(
		nil,
	), // 29: transit_realtime.TripUpdate.StopTimeEvent
	(*TripUpdate_StopTimeUpdate)(
		nil,
	), // 30: transit_realtime.TripUpdate.StopTimeUpdate
	(*TripUpdate_TripProperties)(
		nil,
	), // 31: transit_realtime.TripUpdate.TripProperties
	(*TripUpdate_StopTimeUpdate_StopTimeProperties)(
		nil,
	), // 32: transit_realtime.TripUpdate.StopTimeUpdate.StopTimeProperties
	(*VehiclePosition_CarriageDetails)(
		nil,
	), // 33: transit_realtime.VehiclePosition.CarriageDetails
	(*TripDescriptor_ModifiedTripSelector)(
		nil,
	), // 34: transit_realtime.TripDescriptor.ModifiedTripSelector
	(*TranslatedString_Translation)(
		nil,
	), // 35: transit_realtime.TranslatedString.Translation
	(*TranslatedImage_LocalizedImage)(
		nil,
	), // 36: transit_realtime.TranslatedImage.LocalizedImage
	(*TripModifications_Modification)(
		nil,
	), // 37: transit_realtime.TripModifications.Modification
	(*TripModifications_SelectedTrips)(
		nil,
	), // 38: transit_realtime.TripModifications.SelectedTrips
}
