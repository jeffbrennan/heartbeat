...
func (NyctTripDescriptor_Direction) Descriptor() protoreflect.EnumDescriptor {
	return file_nyct_ext_proto_enumTypes[0].Descriptor()
}

func (NyctTripDescriptor_Direction) Type() protoreflect.EnumType {
	return &file_nyct_ext_proto_enumTypes[0]
}
...
func (NyctTripDescriptor_Direction) EnumDescriptor() ([]byte, []int) {
	return file_nyct_ext_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *TripReplacementPeriod) Reset() {
	*x = TripReplacementPeriod{}
	mi := &file_nyct_ext_proto_msgTypes[0]
...
func (*TripReplacementPeriod) Descriptor() ([]byte, []int) {
	return file_nyct_ext_proto_rawDescGZIP(), []int{0}
}
...
func (x *NyctFeedHeader) Reset() {
	*x = NyctFeedHeader{}
	mi := &file_nyct_ext_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NyctFeedHeader) Descriptor() ([]byte, []int) {
	return file_nyct_ext_proto_rawDescGZIP(), []int{1}
}
...
func (x *NyctTripDescriptor) Reset() {
	*x = NyctTripDescriptor{}
	mi := &file_nyct_ext_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NyctTripDescriptor) Descriptor() ([]byte, []int) {
	return file_nyct_ext_proto_rawDescGZIP(), []int{2}
}
...
func (x *NyctStopTimeUpdate) Reset() {
	*x = NyctStopTimeUpdate{}
	mi := &file_nyct_ext_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NyctStopTimeUpdate) Descriptor() ([]byte, []int) {
	return file_nyct_ext_proto_rawDescGZIP(), []int{3}
}
...
var file_nyct_ext_proto_extTypes = []protoimpl.ExtensionInfo{
	{
...
var (
	...
	E_NyctFeedHeader = &file_nyct_ext_proto_extTypes[0]
)

// Extension fields to TripDescriptor.
var (
	// optional transit_realtime.NyctTripDescriptor nyct_trip_descriptor = 1001;
	E_NyctTripDescriptor = &file_nyct_ext_proto_extTypes[1]
)

// Extension fields to TripUpdate_StopTimeUpdate.
var (
	// optional transit_realtime.NyctStopTimeUpdate nyct_stop_time_update = 1001;
	E_NyctStopTimeUpdate = &file_nyct_ext_proto_extTypes[2]
)

var File_nyct_ext_proto protoreflect.FileDescriptor

const file_nyct_ext_proto_rawDesc = "" +
	"\n" +
	"\x0enyct-ext.proto\x12\x10transit_realtime\x1a\x13gtfs-realtime.proto\"~\n" +
	...
	"\x15nyct_stop_time_update\x12+.transit_realtime.TripUpdate.StopTimeUpdate\x18\xe9\a \x01(\v2$.transit_realtime.NyctStopTimeUpdateR\x12nyctStopTimeUpdateBW\n" +
	"\x1bcom.google.transit.realtimeZ8github.com/yourusername/heartbeat/backend/internal/proto"

var (
	file_nyct_ext_proto_rawDescOnce sync.Once
	file_nyct_ext_proto_rawDescData []byte
)

func file_nyct_ext_proto_rawDescGZIP() []byte {
	file_nyct_ext_proto_rawDescOnce.Do(func() {
		file_nyct_ext_proto_rawDescData = protoimpl.X.CompressGZIP(
			unsafe.Slice(
				unsafe.StringData(file_nyct_ext_proto_rawDesc),
				len(file_nyct_ext_proto_rawDesc),
			),
		)
	})
	return file_nyct_ext_proto_rawDescData
}

var file_nyct_ext_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_nyct_ext_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_nyct_ext_proto_goTypes = []any{
	(NyctTripDescriptor_Direction)(
		0,
	), // 0: transit_realtime.NyctTripDescriptor.Direction
	(*TripReplacementPeriod)(
		nil,
	), // 1: transit_realtime.TripReplacementPeriod
	...
	(*TripUpdate_StopTimeUpdate)(
		nil,
	), // 8: transit_realtime.TripUpdate.StopTimeUpdate
}
var file_nyct_ext_proto_depIdxs = []int32{
...
func init() { file_nyct_ext_proto_init() }
func file_nyct_ext_proto_init() {
	if File_nyct_ext_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_nyct_ext_proto_goTypes,
		DependencyIndexes: file_nyct_ext_proto_depIdxs,
		EnumInfos:         file_nyct_ext_proto_enumTypes,
		MessageInfos:      file_nyct_ext_proto_msgTypes,
		ExtensionInfos:    file_nyct_ext_proto_extTypes,
	}.Build()
	File_nyct_ext_proto = out.File
	file_nyct_ext_proto_goTypes = nil
	file_nyct_ext_proto_depIdxs = nil
}
